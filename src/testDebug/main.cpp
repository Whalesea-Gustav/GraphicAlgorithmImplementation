...
int main()
{
    ...
    Shader equirectangularToCubemapShader("../../../asset/IBL/hdr2cubemap_vs.glsl", "../../../asset/IBL/hdr2cubemap_fs.glsl");
    Shader irradianceShader("../../../asset/IBL/irradiancePrecompute_vs.glsl", "../../../asset/IBL/irradiancePrecompute_fs.glsl");
    ...
    float *data = stbi_loadf("../../../asset/IBL/hdr/newport_loft.hdr", &width, &height, &nrComponents, 0);
