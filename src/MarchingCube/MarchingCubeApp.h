...
class MarchingCubeApp : public Demo
{
public :
    using Demo::Demo;
protected:
...
void MarchingCubeApp::initialize()
{
...
void MarchingCubeApp::destroy()
{

}

void MarchingCubeApp::updateCamera() {
...
Light MarchingCubeApp::getLight()
{
...
void MarchingCubeApp::frameDebug()
{
    //Todo:
