...
class RSMGBufferPass : public RenderPass
{
public:
    ...
    {
        //Init Shader;
        m_pShader = std::make_shared<Shader>("../../../asset/LPV/RSM_GBuffer_vs.glsl",
                                             "../../../asset/LPV/RSM_GBuffer_fs.glsl");
        ...
        glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, gFlux, 0);
...
//            std::cout << "Framebuffer not complete!" << std::endl;
        ...
        glGenTextures(1, &gLightDepthTexture);
        glBindTexture(GL_TEXTURE_2D, gLightDepthTexture);
        ...
        glFramebufferTexture2D(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT, GL_TEXTURE_2D, gLightDepthTexture, 0);
...
//        glDrawBuffers(4, attachments);
    ...
    virtual ~RSMGBufferPass()
    {
        glDeleteFramebuffers(1, &m_gBuffer);
    }
public:
    unsigned int m_gBuffer;
    unsigned int gFlux, gNormal, gPosition;
    unsigned int gLightDepthTexture;
